...
const LoginModal = ({
    visible, password, error, onCancel, onLogin, onChage, onKeyPress
}) => (
    <ModalWrapper visible={visible}>
        <div className={cx('form')}>
            ...
            <input autoFocus type="password" placeholder="비밀번호 입력" value={password} onChange={onChage} onKeyPress={onKeyPress}/>
